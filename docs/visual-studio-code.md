...
A debug adapter and language definitions for CdM family assemblies.
...
> [!TIP]
> Although the debugging adapter supports changing the position of breakpoints during a debugging session, it will not respond to changes in the source code.
>
> If you want to change the code, you should stop the debugging session.
> 