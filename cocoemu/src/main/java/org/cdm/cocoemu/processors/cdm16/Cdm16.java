package org.cdm.cocoemu.processors.cdm16;

import lombok.ToString;
import org.cdm.cocoemu.Component;
import org.cdm.cocoemu.primitives.*;
import org.cdm.cocoemu.processors.MicrocodeLoader;
import org.cdm.cocoemu.processors.cdm16.units.FetchUnit;
import org.cdm.cocoemu.processors.cdm16.units.ImmComputationUnit;
import org.cdm.cocoemu.processors.cdm16.units.alu.Alu;
import org.cdm.cocoemu.processors.cdm16.units.alu.AluInputParameters;
import org.cdm.cocoemu.processors.cdm16.units.alu.AluOutputParameters;
import org.cdm.cocoemu.processors.cdm16.units.bus.BusController;
import org.cdm.cocoemu.processors.cdm16.units.bus.BusControllerInputParameters;
import org.cdm.cocoemu.processors.cdm16.units.bus.BusControllerOutputParameters;
import org.cdm.cocoemu.processors.cdm16.units.decoder.InstructionDecoder;
import org.cdm.cocoemu.processors.cdm16.units.decoder.InstructionDecoderInputParameters;
import org.cdm.cocoemu.processors.cdm16.units.decoder.InstructionDecoderOutputParameters;
import org.cdm.cocoemu.processors.cdm16.units.exceptions.*;

import java.util.ArrayList;
import java.util.List;

import static org.cdm.cocoemu.processors.cdm16.Arithmetic.toBoolean;

public class Cdm16 extends Component<Cdm16.Inputs, Cdm16.Outputs> {

    {
        inputs = new Cdm16.Inputs();
        outputs = new Cdm16.Outputs();
    }
...
//        }
    ...
    protected void updateExternal() {
        for (int i = 0; i < registerFile.getRegisterCount(); ++i) {
            outputs.registers[i] = registerFile.getRegisterValue(i);
        }
