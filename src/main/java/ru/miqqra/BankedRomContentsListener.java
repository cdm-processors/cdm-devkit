...
class BankedRomContentsListener implements HexModelListener {
    private static class Change extends Action {
        private BankedRomContentsListener source;
        ...
        Change(BankedRomContentsListener source, BankedMemContents contents,
        ...
        public String getName() {
            return BankedStrings.get("romChangeAction");
        }
        ...
        public boolean shouldAppendTo(Action other) {
            if (other instanceof BankedRomContentsListener.Change) {
                BankedRomContentsListener.Change o = (BankedRomContentsListener.Change) other;
        ...
        public Action append(Action other) {
            if (other instanceof BankedRomContentsListener.Change) {
                ...
                if (oEnd >= start && end >= o.start) {
                    ...
                    return new BankedRomContentsListener.Change(source, contents, nStart, nOld, nNew);
                }
            }
    ...
    BankedRomContentsListener(Project proj) {
        this.proj = proj;
    }
    ...
    public void bytesChanged(HexModel source, long start,
        ...
        if (enabled && proj != null && oldValues != null) {
            ...
            proj.doAction(new BankedRomContentsListener.Change(this, (BankedMemContents) source,
