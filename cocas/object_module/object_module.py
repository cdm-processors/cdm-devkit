...
class ObjectSectionRecord:
    ...
    name: str
    """Name of the relative section or '$abs' if it is absolute"""
    address: int
    """Address of the section. 0 for every relative section"""
    data: bytearray
    ...
    """Places where the address of this relative section should be added"""
    ...
    """If the relative section should get address that is a multiple of some number"""
